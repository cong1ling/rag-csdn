      ...
      <section class="surface span-8 card-section chat-main">
        <div class="card-header chat-header">
          <div>
            ...
            <h2>{{ session?.articleTitle || "全部文章知识库" }}</h2>
        ...
        <EmptyState
          ...
          badge="CHAT"
          title="还没有消息"
          description="先提出一个你真正关心的问题，例如文章核心观点、实现步骤、删除规则或知识总结。"
        />
        ...
        <div class="composer-container surface-strong">
          ...
          <el-form @submit.prevent="sendMessage" class="composer-form">
            <el-input
              ...
              resize="none"
              maxlength="2000"
              placeholder="例如：这篇文章主要讲了什么？（按 Enter 发送，Shift + Enter 换行）"
        ...
        <div v-if="session" class="stack">
          <div class="surface-strong card-section">
            ...
            <div class="stack meta-list">
              <div class="meta-item">
                ...
                <span class="meta-value">{{ session.sessionType === "SINGLE_ARTICLE" ? "单篇文章" : "全部文章" }}</span>
              </div>
              <div class="meta-item">
                <span class="meta-label">文章标题：</span>
                <span class="meta-value">{{ session.articleTitle || "全部文章知识库" }}</span>
              </div>
              <div class="meta-item">
          ...
          <div class="surface-strong card-section">
            ...
            <div class="stack top-gap tip-list">
              <div class="tip-item">先问“这篇文章主要讲了什么”，快速了解大意。</div>
              <div class="tip-item">再问“有哪些关键步骤、限制或删除规则”，补齐细节。</div>
              <div class="tip-item">如果是全部会话，适合做横向对比和总结归纳。</div>
