...
/**
 * DashVector filter expression converter.
 * Converts filter expressions to SQL WHERE clause syntax for DashVector queries.
 *
 * @author Your Name
 * @since 2027-03-05
 */
public class DashVectorFilterExpressionConverter extends AbstractFilterExpressionConverter {
	...
	protected void doKey(Key key, StringBuilder context) {
		// DashVector stores metadata as direct fields, no JSON extraction needed
